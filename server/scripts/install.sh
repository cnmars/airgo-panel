...
currentVersion=''
latestVersion=''
downloadPrefix='https://github.com/pura-panel/airgo-panel/releases/download/'
githubApi="https://api.github.com/repos/pura-panel/airgo-panel/releases/latest"
manageScript="https://raw.githubusercontent.com/pura-panel/airgo-panel/main/server/scripts/install.sh"
