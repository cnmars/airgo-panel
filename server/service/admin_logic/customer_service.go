...
// 更新客户服务
func (c *CustomerService) UpdateCustomerService(csParams *model.CustomerService) error {
...
// 有效性检测任务
func (c *CustomerService) SubExpirationCheck() error {
	return global.DB.Transaction(func(tx *gorm.DB) error {
		//服务有效性
...
// 更新客户已用流量
func (c *CustomerService) UpdateCustomerServiceTrafficUsed(customerServiceArr *[]model.CustomerService, userIds []int64) error {
...
// 清理流量记录
func (c *CustomerService) ClearCustomerServiceTrafficLog() error {
	y, m, _ := time.Now().Date()
